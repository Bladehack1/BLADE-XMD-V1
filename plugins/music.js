...
cmd({
  ...
  reply("💎 BLADE XMD 💎 Fetching audio... 🎧");
  ...
  if (!spotifySent && !youtubeSent) {
    ...
    reply("💎 BLADE XMD 💎: Spotify audio sent successfully.");
  } else if (youtubeSent) {
    reply("💎 BLADE XMD 💎: YouTube audio sent successfully.");
  }
});
