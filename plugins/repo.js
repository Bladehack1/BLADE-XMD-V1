...
async (conn, mek, m, { from, quoted, reply }) => {
    try {
        ...
        const message = `
*Hello there, Blade XMD User! 👋*

💻 *BLADE XMD Repository Info*:
⭐ *Stars*: ${stargazers_count}
🍴 *Forks*: ${forks_count}
👥 *Users*: ${userCount}
🔗 *Repository*: https://github.com/SilvaTechB/silva-spark-md
> ✨ Blade xmd WhatsApp Bot – Simple. Smart. Feature-packed. 🚀
...
🙌 Thank you for choosing blade XMD – your ultimate bot companion! 🎉
        `;
